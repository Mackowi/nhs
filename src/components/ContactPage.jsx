  ...
  return (
    <div className='flex-grow'>
      <div className='bg-lightGreen'>
        <div id='contactHero' className='md:hidden mx-3 relative'>
          <h1 className='text-center px-6 py-32 font-bold text-darkBlue text-4xl'>
            Contact
          </h1>
        </div>
        <div
          id='contactHero'
          className='hidden md:block container rounded-2xl mx-auto relative'
        >
          <h1 className='text-center px-6 py-24 font-bold text-darkBlue text-4xl'>
            Contact
          </h1>
        </div>
      </div>
      ...
      <div className='container mx-auto py-12 md:py-20 flex flex-col md:space-y-8 text-center dark:text-white '>
        ...
        <div className='p-12 md:p-8 rounded-2xl flex flex-col text-darkBlue'>
          ...
          >
            ...
            <button
              type='submit'
              className='text-2xl text-white py-5 px-10 font-bold bg-lightGreen rounded-full hover:opacity-70 mx-auto'
            >
              Send
            </button>
          </form>
