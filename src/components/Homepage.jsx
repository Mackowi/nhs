  ...
  return (
    <main>
      <div className='container p-8 md:mt-8 mx-auto flex flex-col items-center'>
        <div className='flex flex-col text-darkBlue'>
          ...
          <div className='flex justify-around font-bold mt-4'>
            <p className='text-xl'>Cutting-edge</p>
        ...
        <p className='w-3/4 mt-10 text-xl text-darkBlue'>
          ...
          (NHS) with the aim of providing customers with cutting-edge solutions
          at the best price point. My experience in the industry revealed how
          big OEMs leverage on vendor lock-ins and heavy licensing models. But
          guess what? There are great solutions out there without all those
      ...
      <div className='container p-8 md:mt-4 mx-auto flex flex-col items-center'>
        ...
        <p className='w-3/4 mt-6 text-xl text-darkBlue'>
          At NextGen Hardware Solutions (NHS), our mission is to innovate by
