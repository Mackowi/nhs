    ...
    >
      <div className='bg-blue serviceSection rounded-t-2xl'>
        <div className='serviceElement'>
          ...
          <p>
            We provide solutions in the areas of storage, servers, and
            networking. We make every effort to recommend the best technological
            solution in the most cost-effective option.
          </p>
        </div>
      </div>
      <div className='bg-darkBlue serviceSection'>
        <div className='serviceElement'>
          ...
          <p>
            We ensure seamless integration of our solutions into your IT
            infrastructure, minimizing any disruptions to your business
            operations.
          </p>
        </div>
      </div>
